...
# python manage.py runserver --settings=customspiritdjango.settings.prod_local
...
SECRET_KEY = os.environ.get("SECRET_KEY", '9^37_2a+58-f#zcm)0+7)ausbo2bgz1_x)78-=2do1lb=mmy86')
